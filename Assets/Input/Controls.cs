...
public class @Controls : IInputActionCollection, IDisposable
{
    ...
    ""maps"": [
        {
            ""name"": ""Player1"",
            ""id"": ""9e41c9b2-82e5-4f11-8577-389970e3ba76"",
            ""actions"": [
                {
                    ""name"": ""Movement"",
                    ""type"": ""Button"",
                    ""id"": ""03b1788a-a597-4061-9f25-79a63bf9c1b3"",
                ...
                },
                {
                    ""name"": ""Jump"",
                    ""type"": ""Button"",
                    ""id"": ""45eb0e1a-2b58-4eed-a6f6-13103410b9c0"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """"
                },
                {
                    ""name"": ""Torch"",
                    ""type"": ""Button"",
                    ""id"": ""f5b0c15b-5976-4a32-b734-6ca6f65e2890"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """"
                },
            ...
            ""bindings"": [
                ...
                {
                    ""name"": ""WASD"",
                    ""id"": ""78d60a9f-40d2-4262-bbaa-cd4d0fc9bc65"",
                    ""path"": ""2DVector"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Keyboard"",
                ...
                {
                    ""name"": ""up"",
                    ""id"": ""d0502343-bc4e-4075-9f40-2aa8ffa1e6af"",
                    ""path"": ""<Keyboard>/w"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Keyboard"",
                ...
                {
                    ""name"": ""down"",
                    ""id"": ""aaa9d52d-0b8e-4b54-b5b7-816aa8c62d40"",
                    ""path"": ""<Keyboard>/s"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Keyboard"",
                ...
                {
                    ""name"": ""left"",
                    ""id"": ""1a7919e3-a254-471d-86e3-8b7c1e3ca7d4"",
                    ""path"": ""<Keyboard>/a"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Keyboard"",
                ...
                {
                    ""name"": ""right"",
                    ""id"": ""c7f0a257-e165-42d4-9912-52cc2e1afec7"",
                    ""path"": ""<Keyboard>/d"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Keyboard"",
                ...
                {
                    ""name"": ""D-pad"",
                    ""id"": ""a594364e-b988-4237-8ade-5e2cca8e519d"",
                    ""path"": ""2DVector"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""up"",
                    ""id"": ""db9efc29-5cb9-48f1-9cce-87aae471f381"",
                ...
                {
                    ""name"": ""down"",
                    ""id"": ""a94a5df4-44d1-4424-9b9e-a973cf91829e"",
                ...
                {
                    ""name"": ""left"",
                    ""id"": ""2775e38c-be37-409f-b22a-bfd9aa68af0b"",
                ...
                {
                    ""name"": ""right"",
                    ""id"": ""9e5eef8e-5732-40d2-a86b-af290f507623"",
                ...
                {
                    ""name"": ""Joystick"",
                    ""id"": ""7088e894-ed4b-44da-96d2-6f2a0d928702"",
                    ""path"": ""2DVector"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""up"",
                    ""id"": ""7d9382e1-7ee1-41dc-9f39-a69be7c53717"",
                ...
                {
                    ""name"": ""down"",
                    ""id"": ""2d23d7a4-aeac-4685-94fd-581c1b7d3431"",
                ...
                {
                    ""name"": ""left"",
                    ""id"": ""d61af17b-e863-4814-b001-40e03e5190ac"",
                ...
                {
                    ""name"": ""right"",
                    ""id"": ""8f855104-6422-4b1f-9e65-9c3f0dc441cf"",
                ...
                {
                    ""name"": """",
                    ""id"": ""52d91d4e-e22c-4562-876c-190728797a70"",
        ...
        {
            ""name"": ""Player2"",
            ""id"": ""704e13d5-a504-4942-b21b-e28364fb65be"",
            ""actions"": [
                {
                    ""name"": ""Movement"",
                    ""type"": ""Button"",
                    ""id"": ""15be1b89-8a73-4d9f-9356-8120fa811ad8"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """"
                },
                {
                    ""name"": ""Jump"",
                    ""type"": ""Button"",
                    ""id"": ""c7e361f2-4a16-448a-af71-93ac28c49bd1"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """"
                },
            ...
            ""bindings"": [
                {
                    ""name"": ""Arrows"",
                    ""id"": ""a81b98cd-331f-4a5b-b7bb-7823fc5d86d7"",
                    ""path"": ""2DVector"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Keyboard"",
                ...
                {
                    ""name"": ""up"",
                    ""id"": ""94bcaef8-05ff-464f-88b3-00f64b0b30e1"",
                ...
                {
                    ""name"": ""down"",
                    ""id"": ""f66960a3-ba6a-41c9-808c-5811f85e7890"",
                ...
                {
                    ""name"": ""left"",
                    ""id"": ""0439dde1-4dc5-472f-b744-3dd819e3e8af"",
                ...
                {
                    ""name"": ""right"",
                    ""id"": ""56a2705f-ca28-43d2-b958-4b1272fa76ed"",
                ...
                {
                    ""name"": """",
                    ""id"": ""658e6041-115b-462f-96bb-2a52160fa2f3"",
                    ""path"": ""<Keyboard>/upArrow"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
