...
namespace Mirror
{
    ...
    [AddComponentMenu("Network/NetworkManagerRelayHUD")]
    [RequireComponent(typeof(NetworkManager))]
    [HelpURL("https://mirror-networking.com/docs/Articles/Components/NetworkManagerHUD.html")]
    public class NetworkManagerRelayHUD : MonoBehaviour
    {
        ...
        void StatusLabels()
        {
            ...
            if (NetworkServer.active)
            {
                ...
                //RoomID
                GUILayout.Label("Room ID:" + GetComponent<LightReflectiveMirrorTransport>().serverId);
            }
